///////////////////////////////////////////////////
/* Código do arduino comentando para testes em c */
///////////////////////////////////////////////////
// Para reduzir a quantidade de loops basta      //
// limitar "qtd_teste", variável global próximo  //
// ao main()                                     //
///////////////////////////////////////////////////
...
//////////////////////////////////////////
/* Função que inicializa as matrizes de */
/* distâncias para parede de um gride   */
//////////////////////////////////////////
...
////////////////////////////////////////
// Declaração de vetor de checkpoints //
////////////////////////////////////////
int checkpoints[10][10];

/////////////////////////////////////////
/* Função que marcas os grides que são */
/* checkpoints, ou seja, que robo deve */
/* andar reto mesmo que não exista     */
/* parede nos lados                    */
/////////////////////////////////////////
...
/////////////////////////////////////////
/* Função que verfica se o gride atual */
/* do robo é checkpoint ou não         */
/////////////////////////////////////////
...
*/
  ...
  // Impressão da matriz de probabilidades
   for (l=0; l<10; l++){
     for (c=0; c<10; c++){
        printf ("%.2f ", grid[l][c]);
     }
  ...
  //{
      ...
      // If que simula comportamento do labirinto
      if ( (i == 8 && j == 2) || ( i == 7 && j == 7) || ( i == 6 && j ==7) || ( i == 5 && j == 7) || ( i == 4 && j == 7) || ( i == 1 && j == 9) || (i == 0 && j == 9) || ( i == 0 && j == 4) || ( i == 2 && j == 4) || (i == 8 && j == 6) || (i == 9 && j == 6) ){
       distance = 10;
     }
     else {
       distance = 30;
      ...
      printf ("É check ? (1->sim/0->não) resposta= %d no gride i %d j %d\n", eh_check, i, j);
      if(!eh_check && (abs(distance) > 25 || abs(distance) == 0))// podemos nos movimentar para a direita ***incluir checkpoints para nao virar em algumas posicoes
      {
       ...
       //while(millis()-ini < 1140)// anda um grid a frente
       while(ini < 1140)
       {
          //set_right_wheel_speed(1,255-20);
          //set_left_wheel_speed(1,255); // compensa uma diferenÃƒÂ§a Calibrar velocidade dessa roda provavelmente maior                                          // entre os motores
          ini++;
       }
